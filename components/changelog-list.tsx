...
export function ChangelogList({ entries, showRoastButtons = false }: ChangelogListProps) {
  return (
    <main className="relative h-[500px] sm:h-[600px] lg:h-[800px] overflow-y-auto scrollable scrollbar-thin scrollbar-thumb-zinc-400 dark:scrollbar-thumb-zinc-600 scrollbar-track-zinc-200 dark:scrollbar-track-zinc-800 mx-2 sm:mx-0">
      {/* Timeline line */}
